...
import { Home, Plus, Trophy, User, LogOut, Menu, X, Flame } from 'lucide-react';
...
export function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="md:hidden fixed top-14 right-0 w-48 bg-white border-l border-b border-gray-200 z-40 shadow-lg">
              ...
              <>
                <div className="border-t border-gray-100 pt-2 mt-2">
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 w-full px-3 py-2.5 text-sm text-gray-600 hover:bg-gray-100 rounded-lg"
                  >
      ...
      {user && (
        <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-t border-gray-200 shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
