...
export default function DashboardPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 pb-20 md:pb-0">
      {successMessage && (
        <div className="fixed top-16 md:top-4 left-4 right-4 md:left-auto md:right-4 z-50 md:w-auto bg-white border border-gray-200 rounded-lg px-4 py-3 flex items-center gap-2 shadow-lg">
          ...
          <span className="text-gray-900 text-sm">{successMessage}</span>
        </div>
      )}
      ...
      <div className="px-4 md:px-6 pt-4 md:pt-6">
        ...
        {challenges.length === 0 ? (
          <div className="border-2 border-dashed border-gray-200 rounded-xl p-8 text-center">
            ...
            <h3 className="text-gray-900 font-semibold mb-1">No Challenges Yet</h3>
            <p className="text-gray-500 text-sm mb-4">Create your first challenge!</p>
            ...
            {challenges.map((challenge) => {
              ...
              return (
                <Link key={challenge.$id} href={`/challenge/${challenge.$id}`}>
                  <div className="bg-white border border-gray-200 rounded-xl p-4 hover:shadow-md hover:border-[#c8f135]/30 transition-all">
                    <div className="flex items-start justify-between mb-2">
                      <h3 className="font-bold text-gray-900 text-lg flex-1">{challenge.title}</h3>
                    ...
                    <p className="text-gray-500 text-sm line-clamp-2 mb-3">{challenge.description}</p>
