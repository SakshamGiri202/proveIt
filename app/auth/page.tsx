      ...
      <div className="flex-1 px-4 pb-8">
        <div className="space-y-3 max-w-sm mx-auto">
          ...
          <Link href="/auth/login" className="block">
            <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md hover:border-[#c8f135]/50 transition-all">
              <CardContent className="p-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-gray-900 dark:text-white">Sign In</p>
            ...
            <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md hover:border-[#c8f135]/50 transition-all">
              <CardContent className="p-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-gray-900 dark:text-white">Sign Up</p>
